...
class InteractiveConfig(FairseqDataclass):
    ...
    output: str = field(
        default="-", metadata={"help": "file to output translation result to; use - to print on console"}
    )
    output_details: bool = field(
        default=False,
        metadata={
            "help": "if set, outputs all details including -Source, -Probability, -Detokenized, etc"
        },
    )
